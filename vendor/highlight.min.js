...
end:/$/}]}}})();hljs.registerLanguage("diff",e)})();/*! `ebnf` grammar compiled for Highlight.js 11.9.0 */
...
;hljs.registerLanguage("ebnf",e)})();/*! `haskell` grammar compiled for Highlight.js 11.9.0 */
...
;hljs.registerLanguage("markdown",e)})();/*! `powershell` grammar compiled for Highlight.js 11.9.0 */
...
;hljs.registerLanguage("python-repl",a)})();/*! `scheme` grammar compiled for Highlight.js 11.9.0 */
(()=>{var e=(()=>{"use strict";return e=>{
const t="[^\\(\\)\\[\\]\\{\\}\",'`;#|\\\\\\s]+",n="(-|\\+)?\\d+([./]\\d+)?",r={
$pattern:t,
